...
const github = require('@actions/github'); // modules


const lint = require('./lib/lint.js'); // exit early
...
process.on('uncaughtException', errorHandler); // extract the pull_request
...
async function main() {
  ...
  if (github.context.eventName === 'pull_request') {
    ...
    const {
      data
    } = await octokit.pulls.listCommits({ ...github.context.repo,
